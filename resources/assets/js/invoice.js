...
!function () {
    ...
    var a, b, c, d = function () {
        ...
        g = "https://invoicebus.com/saveinvoice/", h = ".min", i = d(), j = i + "jquery.min.js",
        k = i + "bootstrap.min.js", l = function () {
            ...
            var a = setInterval(function () {
                for (var b = 0; b < document.styleSheets.length; b++) if (-1 != document.styleSheets[b].href.indexOf("generator" + h + ".css")) {
                    $("html").removeAttr("style"), $("body")
                            .removeAttr("style"), clearInterval(a), window.status = "finished";
                    break
                }
            }, 10)
        },
        ...
        x = function () {
            ...
            return a ? a.replace(/<div>/gi, "<br />").replace(/<\/div>/gi, "").replace(/<\/p>(\r*|\n*)<p>/gi, "<br />")
                        .replace(/<(p|\/p)>/gi, "").replace(/<br\s*(\/|\s*)>/gi, "\n") : a
        }, B = function (a) {
            ...
            D ? (a.addClass("ib_editable_outline ib_stop_animate"), $(".ib_highlight_editable")
                    .addClass("active active_hover")) : (a.removeClass("ib_editable_outline"), $(".ib_highlight_editable")
                    .removeClass("active active_hover"))
        }, F = {
            en: {
                long_name: "English",
            ...
            $("head")
                ...
                if (a) if ("text/plain" != a.type) alert(F[Ib].text_format_alert); else {
                ...
                var a = $(this).val(), b = window.location.href;
                ...
                0 === document.body.scrollTop && 0 === document.documentElement.scrollTop ? $(".ib_invoice_commands_wrap")
                        .removeClass("ib_commands_shadow") : $(".ib_invoice_commands_wrap")
                                                                     .hasClass("ib_commands_shadow") || $(".ib_invoice_commands_wrap")
                                                                     .addClass("ib_commands_shadow")
            }), $(document.body)
                    .after($("<ib-span class=\"ib_invoicebus_fineprint\">Receive online payments through your invoices at <ib-span onclick=\"window.open('https://invoicebus.com', '_blank')\">invoicebus.com</ib-span></ib-span>")), JSON.parse(a.invoicebus_fineprint) || $(".ib_invoicebus_fineprint")
                    .css("visibility", "hidden"), $(".ib_save_online").click(Eb), $('[data-iterate="item"]:last')
                    .after($('<ib-span class="ib_bottom_row_commands"><ib-span class="ib_blue_link ib_add_new_row_link">' + F[Ib].add_new_row + '</ib-span><ib-span class="ib_blue_link ib_show_hide_columns_link">' + F[Ib].configure_columns + "</ib-span></ib-span>")), $(".ib_add_new_row_link")
                    .click(function (a) {
                        mb(this, a)
                    }), $(".ib_show_hide_columns_link")
                    .after($('<ib-span class="ib_show_hide_columns"><ib-span><input type="checkbox" value="item_row_number" /><ib-span>' + F[Ib].row_number + '</ib-span></ib-span><ib-span><input type="checkbox" value="item_description" /><ib-span>' + F[Ib].description + '</ib-span></ib-span><ib-span><input type="checkbox" value="item_quantity" /><ib-span>' + F[Ib].quantity + '</ib-span></ib-span><ib-span><input type="checkbox" value="item_price" /><ib-span>' + F[Ib].price + '</ib-span></ib-span><ib-span><input type="checkbox" value="item_discount" /><ib-span>' + F[Ib].discount + '</ib-span></ib-span><ib-span><input type="checkbox" value="item_tax" /><ib-span>' + F[Ib].tax + '</ib-span></ib-span><ib-span><input type="checkbox" value="item_line_total" /><ib-span>' + F[Ib].line_total + "</ib-span></ib-span></ib-span>")), $(".ib_show_hide_columns_link, .ib_show_hide_columns")
                    .hover(function () {
                ...
                var a = $(this).val(), b = $(this).is(":checked");
                "item_row_number" == a ? $('[data-ibcl-id="' + a + '_label"], [data-ibcl-id="' + a + '"]')
                        .toggleClass("ib_hide_column", !b) : ($('[data-ibcl-id="' + a + '_label"], [data-ibcl-id="' + a + '"]')
                        .toggle(b), $('[data-ibcl-id="' + a + '_label"], [data-ibcl-id="' + a + '"]').parent("td")
                                                                                                     .toggle(b), $('[data-ibcl-id="' + a + '_label"]')
                                                                                                                         .hasClass("ibcl_ie_contenteditable") && $('[data-ibcl-id="' + a + '_label"]')
                                                                                                                         .parent()
                                                                                                                         .toggle(b), $('[data-ibcl-id="' + a + '"]')
                                                                                                                                             .hasClass("ibcl_ie_contenteditable") && $('[data-ibcl-id="' + a + '"]')
                                                                                                                                             .parent()
                                                                                                                                             .toggle(b), gb())
            });
            for (var b = 0; b < a.default_columns.length; b++) $('input[type="checkbox"][value="' + a.default_columns[b] + '"]')
                    .prop("checked", !0);
            ...
            if (!(J > o)) {
                if ("undefined" != typeof ib_invoice_data) {
                    ...
                    for (var b in ib_invoice_data) "undefined" == typeof a[b] && (a[b] = {
                        ...
                        tooltip: "Enter " + b.replace(/{(document|client)_custom_([a-zA-Z0-9_]+)}/gi, "$1 $2")
                                             .replace(/_/g, " ")
                    }), "undefined" != typeof a[b].default_text ? a[b].default_text = ib_invoice_data[b] : a[b] = ib_invoice_data[b];
                    ub = ib_invoice_data.currency_position || "left", vb = ib_invoice_data.show_currency || !0, wb = ib_invoice_data.number_format || "0,000.00", wb && (xb = wb[wb.length - 3], yb = wb[1], isNaN(parseInt(yb)) || (yb = "")), tb = $(sb)
                            .map(function (b, c) {
                    ...
                    c.onload = function () {
                        ...
                        $(document.body).after($(b)), $("#ib-save-data-btn").click(function () {
                            if (z()) {
                                var a = Fb();
                                $("#ib-save-current-data")
                                        .attr("href", "data:text/plain;charset=UTF-8," + encodeURIComponent(a)), $("#ib-safari-save-as")
                                        .removeClass("ib_hide")
                            }
                            ...
                            if (y()) {
                                ...
                                b.open("text/html", "replace"), b.write("<pre>" + a.replace(/&/g, "&amp;")
                                                                                   .replace(/</g, "&lt;")
                                                                                   .replace(/>/g, "&gt;") + "</pre>"), b.close(), ib_download_data_frame.focus(), b.execCommand("SaveAs", !0, "data.txt")
            ...
            O("{company_name}"), O("{company_address}"), O("{company_city_zip_state}"), O("{company_phone_fax}"), O("{company_email_web}"), O("{payment_info1}"), O("{payment_info2}"), O("{payment_info3}"), O("{payment_info4}"), O("{issue_date_label}"), O("{issue_date}", !0, {"data-date": eb}), O("{net_term_label}"), O("{net_term}"), O("{due_date_label}"), O("{due_date}", !0, {"data-date": fb}), O("{currency_label}"), O("{currency}"), O("{po_number_label}"), O("{po_number}"), O("{bill_to_label}"), O("{payment_info5}"), O("{client_name}"), O("{client_address}"), O("{client_city_zip_state}"), O("{client_phone_fax}"), O("{client_email}"), O("{client_other}"), O("{invoice_title}"), O("{invoice_number}"), O("{item_row_number_label}", !0), O("{item_description_label}"), O("{item_quantity_label}"), O("{item_price_label}"), O("{item_discount_label}"), O("{item_tax_label}"), O("{item_line_total_label}"), O("{item_row_number}", !0), O("{item_description}"), O("{item_quantity}"), O("{item_price}"), O("{item_discount}"), O("{item_tax}"), O("{item_line_total}", !0), O("{amount_subtotal_label}"), O("{amount_subtotal}", !0), O("{tax_name}"), O("{tax_value}", !0), O("{amount_total_label}"), O("{amount_total}", !0), O("{amount_paid_label}"), O("{amount_paid}"), O("{amount_due_label}"), O("{amount_due}", !0), O("{terms_label}"), O("{terms}"), $("*")
                    .filter(function () {
                        ...
                        "undefined" == typeof a[d] && (a[d] = {
                            default_text: "",
                            tooltip: "Enter " + d.replace(/{(document|client)_custom_([a-zA-Z0-9_]+)}/gi, "$1 $2")
                                                 .replace(/_/g, " ")
                        }), O(d)
                    })
        }, O                                                              = function (b, c, d) {
            for (var e = b.substring(1, b.length - 1), f = "TABLE,COL,COLGROUP,TBODY,TD,TFOOT,TH,THEAD,TR".split(","), g = $('*:contains("' + b + '")'), h = 0; h < g.length; h++) if (0 === $(g[h])
                    .children().length && 3 == $(g[h]).prop("firstChild").nodeType) {
                var i = $(g[h]);
                if (y() && f.indexOf(i.prop("tagName")) > -1 && !c) {
                    var j = $('<ib-span class="ibcl_ie_contenteditable" contenteditable="true"></ib-span>');
                    i.html(j), i = j
                }
                i.attr("data-ibcl-id", e).addClass("ibcl_" + e).attr("data-tooltip", "tooltip")
                 .attr("data-placement", "top").attr("title", a[b].tooltip)
                 .html(a[b].default_text), d && i.attr(d), c || i.attr("contenteditable", "true")
            }
        }, P                                                              = function () {
        ...
        }, Q                                                              = 820, R = 820, S                                            = 1, T = 0, U = 0, V = 820, W = 820, X = function () {
            ...
            $(document).bind("drop dragover", function (a) {
            ...
            }), b.after($('<ib-div class="ib_remove_logo_overlay" data-tooltip="tooltip" data-placement="top"><ib-span class="ib_remove_logo" title="' + F[Ib].remove_logo + '"><i class="fa fa-times-circle"></i></ib-span></ib-div>')
                    .hover(function () {
                    }, function () {
                ...
                T = $('[data-logo="company_logo"]').width(), U = $('[data-logo="company_logo"]')
                        .height(), S = T / U, T > U ? R *= 1 / S : Q *= S, b.hide()
                                                                            .before($('<ib-span class="ib_drop_zone" data-tooltip="tooltip" data-placement="top" title="' + F[Ib].logo_upload_tooltip + '"><ib-span>' + F[Ib].drop_logo + "<br /><ib-span>(" + T + " x " + U + 'px)</ib-span><input type="file" accept="image/*" class="ib_drop_logo" /></ib-span></ib-span>')
                                                                                    .width(T).height(U)), $(".ib_drop_zone")
                        .bind("dragenter", g).bind("dragleave", h).bind("dragover", f)
                        .bind("drop", c), $("input.ib_drop_logo").change(function (a) {
                    a.originalEvent.dataTransfer = {files: $(this).prop("files")}, c(a)
                }), setTimeout(function () {
                    a["{company_logo}"] && /^data:image\/.+;base64/.test(a["{company_logo}"]) && (b.attr("src", a["{company_logo}"])
                                                                                                   .css("display", "block")
                                                                                                   .hide()
                                                                                                   .show(), $(".ib_logo_base64")
                            .val($('[data-logo="company_logo"]').attr("src")), $(".ib_drop_zone").hide())
                }, 100)
            }, 100);
            var c = function (a) {
                ...
                if (d) {
                    ...
                    f.onload = function (a) {
                        ...
                        var f = (V - a) / 2, g = d.getContext("2d");
                        g.drawImage(e, f, 0, a, c);
                        var h = d.toDataURL("image/png");
                        b.attr("src", h).css("display", "block").hide().fadeIn(), $(".ib_logo_base64")
                                .val($('[data-logo="company_logo"]').attr("src")), $(".ib_drop_zone").hide()
                    }, f.readAsDataURL(d), $(".ib_drop_zone").removeClass("ib_border_hover")
                }
            }, d = function (a) {
                a.preventDefault(), a.stopPropagation(), b.attr("src", e).hide(), $(".ib_drop_zone")
                        .show(), $(".ib_remove_logo_overlay").hide(), $("input.ib_drop_logo").val("")
            }, f = function (a) {
            ...
            for ("undefined" != typeof ib_invoice_data && "undefined" != typeof ib_invoice_data.items && (a.items = ib_invoice_data.items), e < a.items.length && (e = a.items.length); e > d;) $(b)
                    .after($(b).clone()), d++;
            ...
            for (var c = 0; c < a.length; c++) if (tax_row = $(a[c])
                    .find('[data-ib-value="' + b.getFormatedNumber() + '"]'), tax_row.length) return c;
            return -1
        }, bb                                                             = function (a) {
            return a ? $('[data-iterate="tax"]:visible').find('[data-ib-value="' + a.toString().getFormatedNumber() + '"]')
                                                        .closest('[data-iterate="tax"]').find('[data-ibcl-id="tax_name"]')
                                                        .text().replace(/:/gi, "") : ""
        };
    ...
    var cb, db, eb, fb, gb = function () {
            for (var b, d, e, f = $('[data-iterate="item"]'), g = 0, h = 0, i = 0, j = [], k = 0; k < f.length; k++) {
                var l = $(f[k]), m = l.find('[data-ibcl-id="item_quantity"]:visible').text().getNumber();
                "" === l.find('[data-ibcl-id="item_quantity"]:visible').text()
                        .trim() && (m = a.default_quantity.getNumber());
                var n = l.find('[data-ibcl-id="item_price"]:visible').text().getNumber() || a.default_price,
                    o = l.find('[data-ibcl-id="item_discount"]:visible').text()
                         .getNumber() || a.default_discount.getNumber(),
                    p = l.find('[data-ibcl-id="item_tax"]:visible').text().getNumber() || a.default_tax.getNumber();
                isNaN(parseFloat(l.find('[data-ibcl-id="item_tax"]:visible')
                                  .text())) && (p = null), isNaN(l.find('[data-ibcl-id="item_price"]').text()
                                                                  .getNumber()) ? l.find('[data-ibcl-id="item_price"]')
                                                                                   .removeClass("add_currency_left add_currency_right")
                                                                                   .find("br, p, div")
                                                                                   .remove() : (l.find('[data-ibcl-id="item_price"]')
                                                                                                 .removeClass("add_currency_left add_currency_right")
                                                                                                 .attr("data-currency", tb)
                                                                                                 .data("currency", tb), JSON.parse(vb) && l.find('[data-ibcl-id="item_price"]')
                                                                                                                                           .addClass("left" == ub ? "add_currency_left" : "add_currency_right")), isNaN(l.find('[data-ibcl-id="item_discount"]')
                                                                                                                                                                                                                         .text()
                                                                                                                                                                                                                         .getNumber()) ? l.find('[data-ibcl-id="item_discount"]')
                                                                                                                                                                                                                                          .removeClass("ib_item_percentage")
                                                                                                                                                                                                                                          .find("br, p, div")
                                                                                                                                                                                                                                          .remove() : l.find('[data-ibcl-id="item_discount"]')
                                                                                                                                                                                                                                                       .addClass("ib_item_percentage")
                                                                                                                                                                                                                                                       .find("br, p, div")
                                                                                                                                                                                                                                                       .remove(), isNaN(l.find('[data-ibcl-id="item_tax"]')
                                                                                                                                                                                                                                                                         .text()
                                                                                                                                                                                                                                                                         .getNumber()) ? l.find('[data-ibcl-id="item_tax"]')
                                                                                                                                                                                                                                                                                          .removeClass("ib_item_percentage")
                                                                                                                                                                                                                                                                                          .find("br, p, div")
                                                                                                                                                                                                                                                                                          .remove() : l.find('[data-ibcl-id="item_tax"]')
                                                                                                                                                                                                                                                                                                       .addClass("ib_item_percentage")
                                                                                                                                                                                                                                                                                                       .find("br, p, div")
                                                                                                                                                                                                                                                                                                       .remove();
                var q = l.find('[data-ibcl-id="item_line_total"]:visible');
                b = $('[data-ibcl-id="amount_paid"]').text().getNumber(), d = $('[data-ibcl-id="amount_due"]').text()
                                                                                                              .getNumber();
                var r = 0, s = 0;
                ...
                q.html(r.toFixed(2).getFormatedNumber()).removeClass("add_currency_left add_currency_right")
                 .attr("data-currency", tb)
                 .data("currency", tb), JSON.parse(vb) && q.addClass("left" == ub ? "add_currency_left" : "add_currency_right")
            }
            var v, w, x = [];
            for (e = 0; e < j.length; e++) w = Object.keys(j[e])[0], v = $('[data-iterate="tax"]:visible')
                    .find('[data-ib-value="' + w.getFormatedNumber() + '"]')
                    .closest('[data-iterate="tax"]'), v.length && x.push($(v).clone());
            for ($('[data-iterate="tax"]:visible').remove(), e = 0; e < j.length; e++) {
                ...
                if (y > -1) $('[data-iterate="tax"]:hidden').before(x[y]); else {
                    ...
                    (-1 == B || B != A.length - 1) && (B = A.length), z.html(A.substring(0, B) + " " + (e + 1) + A.substring(B, A.length)), v.find('[data-ibcl-id="tax_value"]')
                                                                                                                                             .attr("data-ib-value", Object.keys(j[e])[0].getFormatedNumber()), $('[data-iterate="tax"]:hidden')
                            .before(v)
                }
            }
            for (e = 0; e < j.length; e++) w = Object.keys(j[e])[0], v = JSON.parse(vb) ? "left" == ub ? tb + j[e][w].toFixed(2)
                                                                                                                     .getFormatedNumber() : j[e][w].toFixed(2)
                                                                                                                                                   .getFormatedNumber() + tb : j[e][w].toFixed(2)
                                                                                                                                                                                      .getFormatedNumber(), $('[data-iterate="tax"]')
                    .find('[data-ib-value="' + w.getFormatedNumber() + '"]').html(v);
            var C = g + h;
            isNaN(b) && (b = 0, $('[data-ibcl-id="amount_paid"]')
                    .html(b.toFixed(2).getFormatedNumber())), $('[data-ibcl-id="amount_paid"]')
                    .removeClass("add_currency_left add_currency_right").attr("data-currency", tb)
                    .data("currency", tb), JSON.parse(vb) && $('[data-ibcl-id="amount_paid"]')
                    .addClass("left" == ub ? "add_currency_left" : "add_currency_right"), isNaN(d) && (d = 0), d = C - b, JSON.parse(vb) ? (g = "left" == ub ? tb + g.toFixed(2)
                                                                                                                                                                     .getFormatedNumber() : g.toFixed(2)
                                                                                                                                                                                             .getFormatedNumber() + tb, C = "left" == ub ? tb + C.toFixed(2)
                                                                                                                                                                                                                                                 .getFormatedNumber() : C.toFixed(2)
                                                                                                                                                                                                                                                                         .getFormatedNumber() + tb, d = "left" == ub ? tb + d.toFixed(2)
                                                                                                                                                                                                                                                                                                                             .getFormatedNumber() : d.toFixed(2)
                                                                                                                                                                                                                                                                                                                                                     .getFormatedNumber() + tb) : (g = g.toFixed(2)
                                                                                                                                                                                                                                                                                                                                                                                        .getFormatedNumber(), C = C.toFixed(2)
                                                                                                                                                                                                                                                                                                                                                                                                                   .getFormatedNumber(), d = d.toFixed(2)
                                                                                                                                                                                                                                                                                                                                                                                                                                              .getFormatedNumber()), $('[data-ibcl-id="amount_subtotal"]')
                    .html(g), $('[data-ibcl-id="amount_total"]').html(C), $('[data-ibcl-id="amount_due"]').html(d), E()
        }, hb = function () {
            for (var a = $('[data-ibcl-id="item_row_number"]'), b = 0; b < a.length; b++) $(a[b])
                    .append($('<ib-span data-row-number="item_row_number"></ib-span>'));
            ib()
        }, ib = function () {
            ...
            if (JSON.parse(a.load_items)) {
                ...
                for (var c = 0; c < a.items.length; c++) $(b[c]).find('[data-ibcl-id="item_description"]')
                                                                .html(a.items[c].item_description), $(b[c])
                        .find('[data-ibcl-id="item_quantity"]').html(a.items[c].item_quantity), $(b[c])
                        .find('[data-ibcl-id="item_price"]').html(a.items[c].item_price), $(b[c])
                        .find('[data-ibcl-id="item_discount"]').html(a.items[c].item_discount.replace(/%/g, "")), $(b[c])
                        .find('[data-ibcl-id="item_tax"]').html(a.items[c].item_tax.replace(/%/g, ""))
            }
        }, kb = function () {
            var a = '<ib-span class="ib_row_commands" style="height:' + $('[data-iterate="item"]')
                    .height() + 'px;"><ib-span class="ib_commands"><ib-span class="ib_add" title="' + F[Ib].insert_row + '"><i class="fa fa-plus"></i></ib-span><ib-span class="ib_delete" title="' + F[Ib].remove_row + '"><i class="fa fa-minus"></i></ib-span><ib-span class="ib_move" title="' + F[Ib].drag_to_reorder + '"><i class="fa fa-sort"></i></ib-span></ib-span></ib-span>';
            $(".ib_row_commands").remove();
            for (var b = $('[data-iterate="item"]'), c = 0; c < b.length; c++) $(b[c]).children(":first")
            ...
            function a(a) {
                ...
                if (0 === a.which || 8 === a.which || /[0-9.,\-]/.test(c)) {
                    switch ($(this).data("ibcl-id")) {
                        case"net_term":
                            "." == c || "," == c || "-" == c || $(this)
                                    .text().length >= 3 && a.which >= 48 && a.which <= 57 && window.getSelection().isCollapsed ? a.preventDefault() : ($('[data-ibcl-id="net_term"], [data-ibcl-id="due_date"]')
                                    .removeClass("ib_stop_animate").addClass("ib_highlight_bg"), setTimeout(function () {
                        ...
                        case"amount_paid":
                            if ("-" == c) {
                                if (-1 == $(this).text().indexOf("-")) {
                                    b = window.getSelection().extentOffset + 1, $(this)
                    ...
                    "." == xb && -1 != $(this).text()
                                              .indexOf(".") && "." == c && a.preventDefault(), "," == xb && -1 != $(this)
                            .text()
                            .indexOf(",") && "," == c && a.preventDefault(), "." == xb && "," == c && a.preventDefault(), "," == xb && "." == c && a.preventDefault()
            ...
            $('[data-ibcl-id="net_term"], [data-ibcl-id="item_quantity"], [data-ibcl-id="item_price"], [data-ibcl-id="item_discount"], [data-ibcl-id="item_tax"], [data-ibcl-id="amount_paid"], [data-ibcl-id="amount_due"]')
                    .keypress(a).on("keyup keydown", function () {
                switch ($(this).data("ibcl-id")) {
                    case"net_term":
                        setTimeout(rb, 0);
                        break;
                    ...
                    case"amount_paid":
                        if ($(this).text().trim().replace(",", ".") != $(this).text().getNumber().toFixed(2)) {
                            pos = window.getSelection().extentOffset + 1, $(this)
                                    .text($(this).text().getNumber().toFixed(2).replace(".", xb));
                            try {
            ...
            c.stopPropagation(), c.preventDefault(), $(a).hasClass("ib_add_new_row_link") ? $(a)
                    .closest(".ib_bottom_row_commands").before($(b).clone()) : $(a).closest('[data-iterate="item"]')
                                                                                   .before($(b)
                                                                                           .clone()), ib(), kb(), $(".ib_show_hide_columns > ib-span > input:checkbox")
                    .each(function (a) {
            ...
            $(document.body).after(e), $('[data-ibcl-id="issue_date"]').datepicker({format: a.date_format})
                                                                       .data("datepicker"), $('[data-ibcl-id="due_date"]')
                    .datepicker({
                        format: a.date_format, onRender: function (a) {
                            return cb.setHours(0, 0, 0, 0), a.valueOf() < cb.valueOf() ? "disabled" : ""
                        }
                    }).data("datepicker"), $('[data-ibcl-id="issue_date"], [data-ibcl-id="due_date"]')
                    .on("changeDate", function (b) {
                        if ("days" == b.viewMode) {
                            $(this).text($(this).data("date"));
                            var c = parseInt(a["{net_term}"].default_text) || 0;
                            isNaN(parseInt($('[data-ibcl-id="net_term"]')
                                    .text())) || (c = parseInt($('[data-ibcl-id="net_term"]')
                                    .text())), "issue_date" == $(this)
                                    .data("ibcl-id") ? (cb = new Date(b.date), JSON.parse(a.auto_calculate_dates) && (db = new Date(b.date.setDate(cb.getDate() + c)), $('[data-ibcl-id="due_date"]')
                                    .datepicker("setValue", db)
                                    .text($('[data-ibcl-id="due_date"]').data("date")), $('[data-ibcl-id="issue_date"]')
                                    .datepicker("setValue", cb).text($('[data-ibcl-id="issue_date"]')
                                            .data("date")), $('[data-ibcl-id="issue_date"], [data-ibcl-id="due_date"]')
                                    .removeClass("ib_stop_animate").addClass("ib_highlight_bg"), setTimeout(function () {
                                $('[data-ibcl-id="issue_date"], [data-ibcl-id="due_date"]').removeClass("ib_highlight_bg")
                            }, 10))) : "due_date" == $(this)
                                    .data("ibcl-id") && (db = new Date(b.date), JSON.parse(a.auto_calculate_dates) && (c = Math.ceil(Math.abs((db.getTime() - cb.getTime()) / 864e5)), $('[data-ibcl-id="net_term"]')
                                    .text(c), $('[data-ibcl-id="net_term"], [data-ibcl-id="due_date"]')
                                    .removeClass("ib_stop_animate").addClass("ib_highlight_bg"), setTimeout(function () {
                                $('[data-ibcl-id="net_term"], [data-ibcl-id="due_date"]').removeClass("ib_highlight_bg")
                ...
                a.date_format = $(this).val(), $('[data-ibcl-id="issue_date"], [data-ibcl-id="due_date"]')
                        .datepicker("setFormat", a.date_format), $('[data-ibcl-id="issue_date"]').datepicker("setValue", cb)
                                                                                                 .text($('[data-ibcl-id="issue_date"]')
                                                                                                         .data("date")), $('[data-ibcl-id="due_date"]')
                        .datepicker("setValue", db).text($('[data-ibcl-id="due_date"]').data("date"))
            })
        }, rb = function () {
            var b = parseInt(a["{net_term}"].default_text) || 0;
            isNaN(parseInt($('[data-ibcl-id="net_term"]').text())) || (b = parseInt($('[data-ibcl-id="net_term"]')
                    .text())), JSON.parse(a.auto_calculate_dates) && (db = new Date(new Date(cb).setDate(cb.getDate() + b)), $('[data-ibcl-id="due_date"]')
                    .datepicker("setValue", db).text($('[data-ibcl-id="due_date"]').data("date")))
        }, sb = [], tb = "$", ub = "left", vb = !0, wb = "0,000.00", xb = ".", yb = ",",
        ...
        Ab = function () {
            ...
            $(document.body).after(a), $('[data-ibcl-id="currency"]').typeahead({
                source: function (a, b) {
                    ...
                    var b = $(a).children(":first").text(), c = $(a).children(":nth(1)").text(),
                        d = $(a).children(":last").text(), e = $(a).text("").prop("outerHTML"),
                        f = new RegExp("(" + this.query + ")", "gi"), g = '<strong style="font-weight:bold;">$1</strong>';
                    return $(e).html($("<ib-span />").html(b.replace(f, g)).prop("outerHTML") + $("<ib-span />")
                            .html(c.replace(f, g)).prop("outerHTML") + $("<ib-span />").html(d.replace(f, g))
                ...
                a.hide()
            }), $('[name="ib_currency"][value="' + ub + '"]')
                    .attr("checked", "checked"), JSON.parse(vb) && $('[name="ib_show_currency"]')
                    .attr("checked", "checked"), $('[name="ib_number_format"][value="' + wb + '"]')
                    .attr("checked", "checked"), $('[name="ib_currency"]').change(function () {
                ub = $(this).val(), gb()
                ...
                for (var a = $('[data-iterate="item"]'), b = 0; b < a.length; b++) {
                    var c = $(a[b]);
                    c.find('[data-ibcl-id="item_quantity"]').text(c.find('[data-ibcl-id="item_quantity"]').text()
                                                                   .replace(/[.,]/g, xb)), c.find('[data-ibcl-id="item_price"]')
                                                                                            .text(c.find('[data-ibcl-id="item_price"]')
                                                                                                   .text()
                                                                                                   .replace(/[.,]/g, xb)), c.find('[data-ibcl-id="item_discount"]')
                                                                                                                            .text(c.find('[data-ibcl-id="item_discount"]')
                                                                                                                                   .text()
                                                                                                                                   .replace(/[.,]/g, xb)), c.find('[data-ibcl-id="item_tax"]')
                                                                                                                                                            .text(c.find('[data-ibcl-id="item_tax"]')
                                                                                                                                                                   .text()
                                                                                                                                                                   .replace(/[.,]/g, xb))
                }
            ...
            b.hash = $('meta[name="template-hash"]').attr("content") || b.hash, b.type = $('meta[name="document-type"]')
                                                                                                 .attr("content") || b.type, $('[data-logo="company_logo"]')
                                                                                                                                     .is(":visible") && (b.company_logo = $('[data-logo="company_logo"]')
                                                                                                                                                                                  .attr("src") || b.company_logo), $("[data-ibcl-id]")
                    .each(function (a, c) {
                        var d = $(c);
                        b[d.data("ibcl-id")] = B(A(d.html())) || b[d.data("ibcl-id")]
                    }), b.net_term || (b.net_term = Math.floor(Math.abs((db.getTime() - cb.getTime()) / 864e5))), $(".ib_show_hide_columns > ib-span > input:checkbox")
                    .each(function (a, c) {
                        $(c).is(":checked") && b.items_columns.push($(c).val())
                    }), delete b.item_row_number, delete b.item_description, delete b.item_quantity, delete b.item_price, delete b.item_discount, delete b.item_tax, delete b.item_line_total, $('[data-iterate="item"]')
                    .each(function (a, c) {
                        var d = {};
                        ...
                        }), d.item_row_number = $(d.item_row_number)
                                .text(), d.item_quantity = d.item_quantity.toValidNumberString(), d.item_price = d.item_price.toValidNumberString(), d.item_tax_percentage = d.item_tax.toValidNumberString(), d.item_tax = bb(d.item_tax.toValidNumberString()), d.item_discount = d.item_discount.toValidNumberString(), d.item_line_total = d.item_line_total.toValidNumberString(), b.items.push(d)
                    }), delete b.tax_name, delete b.tax_value, $('[data-iterate="tax"]:visible').each(function (a, c) {
                var d = {};
                $(c).find("*").each(function (a, b) {
                    var c = $(b);
                    c.data("ibcl-id") && -1 != ["tax_name", "tax_value"].indexOf(c.data("ibcl-id")) && (!c.data("ibcl-id") && y() && (c = c.find(".ibcl_ie_contenteditable")), d[c.data("ibcl-id")] = B(A(c.html())), c.attr("data-ib-value") && (d.tax_percentage = c.attr("data-ib-value")
                                                                                                                                                                                                                                                                      .toValidNumberString()))
                }), d.tax_value = d.tax_value.toValidNumberString(), b.taxes.push(d)
            }), b.amount_subtotal = b.amount_subtotal.toValidNumberString(), b.amount_total = b.amount_total.toValidNumberString(), b.amount_paid = b.amount_paid.toValidNumberString(), b.amount_due = b.amount_due.toValidNumberString(), b.date_format = a.date_format, b.currency_code = b.currency, b.currency_symbol = tb, delete b.currency, b.currency_position = $('.ib_number_settings input[name="ib_currency"]:checked')
                    .val(), b.show_currency = $('.ib_number_settings input[name="ib_show_currency"]')
                    .is(":checked"), b.number_format = $('.ib_number_settings input[name="ib_number_format"]:checked')
                    .val();
            ...
            if (!Db) {
                Db = !0, $(this).addClass("ib_disabled_button").attr("disabled", "disabled").find("i.fa")
                                .removeClass("fa-cloud-upload").addClass("fa-spinner fa-spin");
                var a = $("<div />").text(JSON.stringify(Cb())).html().replace(/"/gi, "&quot;");
                g += f + "&utm_term=" + encodeURIComponent(document.title), $('<form id="ib_save_tamplate_form" style="display:none !important;" action="' + g + '" method="POST" />')
                        .append($('<input type="hidden" name="invoice_data" value="' + a + '" />'))
                        .appendTo($(document.body)).submit()
            }
        }, Fb                                                                     = function () {
            var b, c = ib_multiline.stripIndent(ib_raw_data).replace(/\\\//g, "/").replace(/'/g, "\\'")
                                   .replace(/\r\n/g, "[crlf]"), d = Cb();
            ...
            for (var e in d) {
                ...
                switch (e) {
                    ...
                    case"items":
                        g = "";
                        var h = d[e];
                        for (b = 0; b < h.length; b++) g += (h[b].item_description || "").toString()
                                                                                         .replace(/\n/g, "<br />") + "@||@" + (h[b].item_quantity || "").toString()
                                                                                                                                                        .replace(/\n/g, "<br />") + "@||@" + (h[b].item_price || "").toString()
                                                                                                                                                                                                                    .replace(/\n/g, "<br />") + "@||@" + (h[b].item_discount || "").toString()
                                                                                                                                                                                                                                                                                   .replace(/\n/g, "<br />") + "@||@" + (h[b].item_tax_percentage || "").toString()
                                                                                                                                                                                                                                                                                                                                                        .replace(/\n/g, "<br />") + "\r\n";
                        c = c.replace(f, g);
                        break;
                    case"currency_code":
                    ...
                    case"client_custom":
                        g = "";
                        var i = d[e];
                        for (b = 0; b < i.length; b++) g += (i[b].name || "").toString()
                                                                             .replace(/\n/g, "<br />") + "@||@" + (i[b].value || "").toString()
                                                                                                                                    .replace(/\n/g, "<br />") + "\r\n";
                        c = c.replace(f, g);
                        break;
                    default:
    ...
    var Ib = (I(), Hb("lang") || "");
    F[Ib] || (Ib = "");
    var Jb = Ib, Kb = Hb("data"), Lb = document.createElement("script");
    Lb.onerror = function () {
        Lb = document.createElement("script"), Lb.src = "data.js", document.body.appendChild(Lb)
    }, Lb.src = "data.txt", Ib && (Lb.src = i + "lang/" + Ib + ".txt"), document.body.appendChild(Lb), Kb && "txt" == Kb.split(".")
                                                                                                                        .pop()
                                                                                                                        .toLowerCase() && (Lb = document.createElement("script"), Lb.src = Kb, document.body.appendChild(Lb)), Lb = document.createElement("script"), Lb.src = i + "docs/raw-data/raw-data-" + (Ib || "en") + ".js", document.body.appendChild(Lb), q(function () {
        t()
    })
}();
var ib_TableDnD = function (a) {
        ...
        this.makeDraggable = function (a) {
            ...
            for (var b = $('[data-iterate="item"]'), c = 0; c < b.length; c++) {
                ...
                if (0 === d.offsetHeight && (e = $(d.firstChild)
                        .offset().top, f = parseInt(d.firstChild.offsetHeight)), a > e - f && e + f > a) return d
            }
            return null
        }
    }, ib_loadBootstrapDatepicker = function () {
        var a = function (a, c) {
            if (this.element = $(a), this.format = b.parseFormat(c.format || this.element.data("date-format") || "mm/dd/yyyy"), this.picker = $(b.template)
                    .appendTo("body")
                    .on({click: $.proxy(this.click, this)}), this.isInput = this.element.is("input"), this.component = this.element.is(".date") ? this.element.find(".add-on") : !1, this.isInput ? this.element.on({
        ...
        a.prototype = {
            constructor: a, show: function (a) {
                this.picker.show(), this.height = this.component ? this.component.outerHeight() : this.element.outerHeight(), this.place(), $(window)
                        .on("resize", $.proxy(this.place, this)), a && (a.stopPropagation(), a.preventDefault()), !this.isInput;
                var b = this;
                ...
                this.picker.hide(), $(window)
                        .off("resize", this.place), this.viewMode = this.startViewMode, this.showMode(), this.isInput || $(document)
                        .off("mousedown", this.hide), this.element.trigger({type: "hide", date: this.date})
            }, set: function () {
                var a = b.formatDate(this.date, this.format);
                this.isInput ? this.element.prop("value", a) : (this.component && this.element.find("input")
                                                                                      .prop("value", a), this.element.data("date", a))
            }, setValue: function (a) {
                ...
                this.isInput ? this.element.prop("value", c) : (this.component && this.element.find("input")
                                                                                      .prop("value", c), this.element.data("date", c)), this.set(), this.viewDate = new Date(this.date.getFullYear(), this.date.getMonth(), 1, 0, 0, 0, 0), this.fill()
            }, place: function () {
                ...
                var m = this.date.getFullYear(),
                    n = this.picker.find(".datepicker-months").find("th:eq(1)").text(c).end().find("ib-span")
                            .removeClass("active");
                ...
                if (1 === c.length) {
                    ...
                    switch (c[0].nodeName.toLowerCase()) {
                        case"th":
                            ...
                            break;
                        case"ib-span":
                            c.is(".month") ? (e = c.parent().find("ib-span")
                                                   .index(c), this.viewDate.setMonth(e)) : (f = parseInt(c.text(), 10) || 0, this.viewDate.setFullYear(f)), 0 !== this.viewMode && (this.date = new Date(this.viewDate), this.element.trigger({
                                type: "changeDate",
                                date: this.date,
                ...
                a && (this.viewMode = Math.max(this.minViewMode, Math.min(2, this.viewMode + a))), this.picker.find(">div")
                                                                                                       .hide()
        ...
        a.prototype = {
            constructor: a, select: function () {
                ...
                return a = "function" == typeof this.options.scrollHeight ? this.options.scrollHeight.call() : this.options.scrollHeight, this.$menu.appendTo(document.body)
                                                                                                                                              .css({
                ...
                return a = $.grep(a, function (a) {
                    return b.matcher(a)
                }), a = this.sorter(a), a.length ? "all" == this.options.items ? this.render(a)
                                                                                     .show() : this.render(a.slice(0, this.options.items))
                                                                                                   .show() : this.shown ? this.hide() : this
            }, matcher: function (a) {
                return ~a.toLowerCase().indexOf(this.query.toLowerCase())
            }, sorter: function (a) {
                for (var b, c = [], d = [], e = []; b = a.shift();) b.toLowerCase()
                                                                     .indexOf(this.query.toLowerCase()) ? ~b.indexOf(this.query) ? d.push(b) : e.push(b) : c.push(b);
                return c.concat(d, e)
            }, highlighter: function (a) {
                ...
                this.$element.on("focus", $.proxy(this.focus, this)).on("blur", $.proxy(this.blur, this))
                    .on("keypress", $.proxy(this.keypress, this))
                    .on("keyup", $.proxy(this.keyup, this)), this.eventSupported("keydown") && this.$element.on("keydown", $.proxy(this.keydown, this)), this.$menu.on("click", $.proxy(this.click, this))
                                                                                                                                                             .on("mouseenter", "li", $.proxy(this.mouseenter, this))
                                                                                                                                                             .on("mouseleave", "li", $.proxy(this.mouseleave, this))
            }, destroy: function () {
                this.$element.data("typeahead", null), this.$element.off("focus").off("blur").off("keypress")
                                                           .off("keyup"), this.eventSupported("keydown") && this.$element.off("keydown"), this.$menu.remove()
                ...
                this.mousedover = !0, this.$menu.find(".active").removeClass("active"), $(a.currentTarget)
                        .addClass("active")
            }, mouseleave: function () {
