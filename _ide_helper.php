...
namespace {
    ...
    class App extends \Illuminate\Support\Facades\App
    {
        ...
        {
            //Method inherited from \Illuminate\Container\Container
            \Illuminate\Foundation\Application::addContextualBinding($concrete, $abstract,
                $implementation);
        }
    ...
    class Cookie extends \Illuminate\Support\Facades\Cookie
    {
        ...
        public static function make(
            ...
            return \Illuminate\Cookie\CookieJar::make($name, $value, $minutes, $path, $domain,
                $secure, $httpOnly);
        }
        ...
        public static function forever(
            ...
            return \Illuminate\Cookie\CookieJar::forever($name, $value, $path, $domain, $secure,
                $httpOnly);
        }
    ...
    class DB extends \Illuminate\Support\Facades\DB
    {
        ...
        /**
         * Set the default fetch mode for the connection, and optional arguments for the given
         * fetch mode.
         *
         * @param int   $fetchMode
        ...
        public static function setFetchMode(
            ...
            //Method inherited from \Illuminate\Database\Connection
            return \Illuminate\Database\MySqlConnection::setFetchMode($fetchMode, $fetchArgument,
                $fetchConstructorArgument);
        }
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model
    {
        ...
        {
            return \Illuminate\Database\Eloquent\Builder::where($column, $operator, $value,
                $boolean);
        }
        ...
        public static function has(
            ...
            return \Illuminate\Database\Eloquent\Builder::has($relation, $operator, $count,
                $boolean, $callback);
        }
        ...
        {
            return \Illuminate\Database\Eloquent\Builder::doesntHave($relation, $boolean,
                $callback);
        }
        ...
        {
            return \Illuminate\Database\Eloquent\Builder::whereHas($relation, $callback, $operator,
                $count);
        }
        ...
        {
            return \Illuminate\Database\Eloquent\Builder::orWhereHas($relation, $callback,
                $operator, $count);
        }
        ...
        public static function join(
            ...
            return \Illuminate\Database\Query\Builder::join($table, $one, $operator, $two, $type,
                $where);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::joinWhere($table, $one, $operator, $two,
                $type);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::rightJoin($table, $first, $operator,
                $second);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::rightJoinWhere($table, $one, $operator,
                $two);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::crossJoin($table, $first, $operator,
                $second);
        }
        ...
        public static function whereColumn(
            ...
            return \Illuminate\Database\Query\Builder::whereColumn($first, $operator, $second,
                $boolean);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::whereDate($column, $operator, $value,
                $boolean);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::whereTime($column, $operator, $value,
                $boolean);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::whereDay($column, $operator, $value,
                $boolean);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::whereMonth($column, $operator, $value,
                $boolean);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::whereYear($column, $operator, $value,
                $boolean);
        }
    ...
    class File extends \Illuminate\Support\Facades\File
    {
        ...
        {
            return \Illuminate\Filesystem\Filesystem::copyDirectory($directory, $destination,
                $options);
        }
    ...
    class Lang extends \Illuminate\Support\Facades\Lang
    {
        ...
        public static function transChoice(
            ...
            return \Illuminate\Translation\Translator::transChoice($id, $number, $parameters,
                $domain, $locale);
        }
    ...
    class Request extends \Illuminate\Support\Facades\Request
    {
        ...
        public static function duplicate(
            ...
            return \Illuminate\Http\Request::duplicate($query, $request, $attributes, $cookies,
                $files, $server);
        }
         ...
         * @param array           $query      The GET parameters
         * @param array           $request    The POST parameters
         * @param array           $attributes The request attributes (parameters parsed from the
         *                                    PATH_INFO, ...)
         * @param array           $cookies    The COOKIE parameters
         * @param array           $files      The FILES parameters
         * @param array           $server     The SERVER parameters
        ...
        public static function initialize(
            ...
            return \Illuminate\Http\Request::initialize($query, $request, $attributes, $cookies,
        ...
        public static function create(
            ...
            //Method inherited from \Symfony\Component\HttpFoundation\Request
            return \Illuminate\Http\Request::create($uri, $method, $parameters, $cookies, $files,
                $server, $content);
        }
         ...
         *  * Request::HEADER_CLIENT_PROTO: defaults to X-Forwarded-Proto (see getScheme() and
         *  isSecure())
         *
         ...
         * If the HTTP method parameter override is enabled, an html-form with method "POST" can be
         * altered and used to send a "PUT" or "DELETE" request via the _method request parameter.
         ...
         *
         * This method is mainly useful for libraries that want to provide some flexibility. If you
         * don't need the flexibility in controllers, it is better to explicitly get request
         * parameters from the appropriate public property instead (attributes, query, request).
         *
         ...
         * Gets the user info.
         *
         * @return string A user name and, optionally, scheme-specific information about how to
         ...
         * downloadable document archives. Furthermore, they can be used to reduce the link size in
         * documents.
         *
         ...
         *
         * @param string       $format    The format
         * @param string|array $mimeTypes The associated mime types (the preferred one must be the
         *                                first as it will be used as the content type)
         *
         * @static
         */
    ...
    class Response extends \Illuminate\Support\Facades\Response
    {
        ...
        public static function jsonp(
            ...
            return \Illuminate\Routing\ResponseFactory::jsonp($callback, $data, $status, $headers,
                $options);
        }
        ...
        public static function download(
            ...
            return \Illuminate\Routing\ResponseFactory::download($file, $name, $headers,
                $disposition);
        }
        ...
        {
            return \Illuminate\Routing\ResponseFactory::redirectTo($path, $status, $headers,
                $secure);
        }
        ...
        public static function redirectToRoute(
            ...
            return \Illuminate\Routing\ResponseFactory::redirectToRoute($route, $parameters,
                $status, $headers);
        }
        ...
        public static function redirectToAction(
            ...
            return \Illuminate\Routing\ResponseFactory::redirectToAction($action, $parameters,
                $status, $headers);
        }
        ...
        {
            return \Illuminate\Routing\ResponseFactory::redirectGuest($path, $status, $headers,
                $secure);
        }
        ...
        public static function redirectToIntended(
            ...
            return \Illuminate\Routing\ResponseFactory::redirectToIntended($default, $status,
                $headers, $secure);
        }
    ...
    class Storage extends \Illuminate\Support\Facades\Storage
    {
        ...
        {
            return \Illuminate\Filesystem\FilesystemAdapter::putFileAs($path, $file, $name,
                $visibility);
        }
    ...
    class Form extends \Collective\Html\FormFacade
    {
        ...
        {
            return \Collective\Html\FormBuilder::selectRange($name, $begin, $end, $selected,
                $options);
        }
    ...
    class Html extends \Collective\Html\HtmlFacade
    {
        ...
        public static function linkAction(
            ...
            return \Collective\Html\HtmlBuilder::linkAction($action, $title, $parameters,
                $attributes);
        }
